...
public class ListViewConverter {
    public static class SchoolYearConverter extends StringConverter<SchoolYear> {
        @Override
        ...
        public SchoolYear fromString(String string) {
            try {
                ...
                String newYear = String.format("%d-%d", LocalDate.now().getYear(),
    ...
    public static class ClassroomConverter extends StringConverter<Classroom> {
        @Override
        public String toString(Classroom schema) {
            return schema.toString();
        }

        @Override
        public Classroom fromString(String string) {
            return new Classroom(string);            
        }
    }
}